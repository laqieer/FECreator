...
workbench with a narrow dialogue-background source workflow, deterministic imaging,
immutable jobs/lineage, human review, and a `fe-gba-portrait-standard` export
compatible with FEBuilderGBA (file-based, ROM-free).
